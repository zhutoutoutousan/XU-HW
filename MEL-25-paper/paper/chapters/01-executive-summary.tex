...
\begin{figure}[h]
    ...
    \node[member] (entrepreneurs) at (-6,3) {Entrepreneurs\\�?-50M+ NAV};
    ...
    \node[metric] (deals) at (6,0) {�?00M+\\Deal Flow};
...
\node[current] (deals) at (2,3) {�?00M+\\Deal Flow};
...
\node[target] (target_deals) at (2,0) {�?00M+\\Target Deals};
...
\node[fill=yellow!20, draw=yellow!80, thick, rounded corners] at (0,-6) 
    {\textbf{Success Metrics: 1,200+ Members, �?00M+ Deal Flow, 95+ NPS}};
